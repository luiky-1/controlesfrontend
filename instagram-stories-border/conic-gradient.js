 ...
 * MIT license
 */
 /*-- a partir de aqui es la opcion copiada de github para insertar por medio de css el efecto q conseguimos en esta pantalla.
 solo para los navegadores q no soportan el conic gradient*/
